...
h_TOV = 1e-4;
r_1, δε_1, δλ_1 = NeutronStarOscillations.BDNKInitialData.compute_initial_data(BDNK_star, 4.0h_TOV; u2_0 = 1000.0);
r_2, δε_2, δλ_2 = NeutronStarOscillations.BDNKInitialData.compute_initial_data(BDNK_star, 2.0h_TOV; u2_0 = 1000.0);
r_3, δε_3, δλ_3 = NeutronStarOscillations.BDNKInitialData.compute_initial_data(BDNK_star, h_TOV; u2_0 = 1000.0);
